...
class Application:
    ...
    def __init__(self):
        ...
        self.lastEditedIdevice = -1 # Stores last edited idevice to open it on
                                    # refresh
    ...
    def processArgs(self):
        ...
        try:
            options, packages = getopt(sys.argv[1:], 
                                       "hV", ["help", "version", "standalone", "child-process"])
        except GetoptError:
            self.usage()
            sys.exit(2)
        ...
        for option in options:
            ...
            elif option[0].lower() == '--child-process':
    ...
    def usage(self):
        ...
        print "  --child-process   Don't delete old profile (DEBUG)"
