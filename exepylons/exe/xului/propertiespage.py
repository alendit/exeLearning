...
class PropertiesPage(RenderableLivePage):
    ...
    imgFieldNames     = ('pp_backgroundImg', 'pp_footerImg')
    ...
    def fillInField(self, client, fieldId):
        ...
        if fieldId in self.booleanFieldNames:
            ...
            path = ""
            propName = ""
            if fieldId == "pp_backgroundImg":
                propName = "backgroundImg"
            elif fieldId == "pp_footerImg":
                propName = "footerImg"
            if getattr(self.package, propName):
                path += "resources/%s" % getattr(self.package,
                    propName).basename()
            client.sendScript(js(
